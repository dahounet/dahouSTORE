...
<div class="main">
	...
	<div class="main-right">
		<div class="tabview">
			<ul class="tabpanel">
				<li class="main-right-tab-curr"><a href="javascript:void();">全局日志</a></li>
			</ul>
		</div>
		<div class="logslist-wrap">
			<div class="logslist">
				...
				$result1=$db->query("SELECT * FROM `store_log` ORDER BY  `logid` DESC");
				$result2=$db->query("SELECT * FROM `store_log` ORDER BY  `logid` DESC LIMIT $start, {$num}");
