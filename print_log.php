...
<div class="main">
	...
	<div class="main-right">
		<div class="tabview">
			<ul class="tabpanel">
				<li class="main-right-tab-curr"><a href="#">小票打印操作日志</a></li>
			</ul>
		</div>
		<div class="logslist-wrap">
			<div class="logslist">
				<table class="logslist-tb">
					<thead>
						<tr>
							<th style="width:15%;">日志编号</th>
							<th style="width:15%;">打印的订单号</th>
							<th style="width:40%;">打印的内容</th>
							<th style="width:14%;">时间</th>
							<th style="width:11%;">发起打印者IP</th>
						</tr>
					</thead>
					<tbody>
				<?php
				...
				$result1=$db->query("SELECT * FROM `store_print_log` ORDER BY  `logid` DESC");
				$result2=$db->query("SELECT * FROM `store_print_log` ORDER BY  `logid` DESC LIMIT $start, {$num}");
