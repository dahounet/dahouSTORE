...
<div class="main">
	...
	<div class="main-right">
		<div class="tabview">
			<ul class="tabpanel">
				<li class="main-right-tab-curr"><a href="#">全部订单操作日志</a></li>
			</ul>
		</div>
		<div class="logslist-wrap">
			<div class="logslist">
				<table class="logslist-tb">
					<thead>
						<tr>
							<th style="width:10%;">日志编号</th>
							<th style="width:10%;">操作的订单号</th>
							<th style="width:32%;">操作内容</th>
				...
				$result1=$db->query("SELECT * FROM `store_orders_log` ORDER BY  `logid` DESC");
				$result2=$db->query("SELECT * FROM `store_orders_log` ORDER BY  `logid` DESC LIMIT $start, {$num}");
